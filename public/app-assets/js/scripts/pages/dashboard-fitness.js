...
(function (window, document, $) {
    ...
    // fitness-stats
    $("#fitness-stats").sparkline(
        [
            5, 6, 7, 8, 9, 10, 13, 15, 13, 12, 10, 9, 10, 12, 15, 18, 16, 14,
            12, 10, 8, 5,
        ],
        {
            type: "bar",
    ...
    var weeklyActivityChart = Morris.Line({
        ...
        smooth: true,
        pointSize: 3,
        pointStrokeColors: ["#FF7588", "#acc937", "#FFA87D"],
        ...
        lineWidth: 3,
        hideHover: "auto",
        lineColors: ["#FF7588", "#acc937", "#FFA87D"],
...
$(window).on("load", function () {
    ...
    var mapsLeafletUserLocation = L.map("maps-leaflet-user-location").setView(
        [42.35, -71.08],
        10
    );
