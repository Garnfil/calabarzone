            ...
            <div class="content-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('admin.city_municipality.update', $data->id) }}" method="post" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                                        ...
                                        <div class="col-lg-6 my-1">
                                            ...
                                            <fieldset>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" class="custom-control-input" name="type" id="type1" value="city" {{ $data->type == 'city' ? 'checked' : null }}>
                                                    <label class="custom-control-label" for="type1">City</label>
                                                </div>
                                            </fieldset>
                                            <fieldset>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" class="custom-control-input" name="type" id="type2" {{ $data->type == 'municipality' ? 'checked' : null }} value="municipality">
                                        ...
                                        <div class="col-lg-6 my-1">
                                            ...
                                            <select name="province_id" id="province" class="select2 form-control">
                                                ...
                                                @foreach ($provinces as $province)
                                                    <option {{ $data->province_id == $province->id ? 'selected' : null }} value="{{ $province->id }}">{{ $province->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
