                            ...
                            <div class="col-lg-8">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 my-1">
                                        ...
                                        <input type="text" name="destination" id="destination" class="form-control" value="{{ $event->destination }}">
                                    </div>
                                    <div class="col-lg-6 my-1">
                                    ...
                                    <div class="col-lg-6 my-1">
                                        ...
                                        <textarea name="what_to_bring" id="what_to_bring" cols="30" rows="10" class="form-control">{{ $event->what_to_bring }}</textarea>
                                        <span class="text-danger danger">
                                            @error('what_to_bring')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="col-lg-6 my-1">
                                        ...
                                        <input type="text" class="form-control" name="latitude"
                                            id="latitude" value="{{ $event->latitude }}">
                                    </div>
                                    <div class="col-lg-6 my-1">
