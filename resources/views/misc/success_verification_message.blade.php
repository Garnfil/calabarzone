...
<head>
    ...
    <title>CALABARZONE - VERIFY MESSAGE</title>
...
<body>
    <div class="container d-flex align-items-center justify-content-center" style="height: 100vh;">
        <div class="d-flex justify-content-center align-items-center bg-white border-success-3 my-2 p-3 flex-column veify-box" style="border: 2px solid #16468a;">
            <img class="brand-logo my-2" alt="stack admin logo"
                src="{{ URL::asset('app-assets/images/logo/logo_zone.png') }}" width="200">
            <h3 class="text-center" style="color: #16468a;">Thank you for your verification</h2>
            <h2 class="text-center" style="text-transform: uppercase;"> Your email has been successfully verified now!<h2>
        </div>
    </div>
</body>
