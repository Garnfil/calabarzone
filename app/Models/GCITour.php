...
class GCITour extends Model
{
    ...
    protected $fillable = ['tour_name', 'tour_type', 'tour_cover', 'what_to_wear', 'flyers', 'best_time', 'tour_duration', 'inclusions', 'province', 'inclusion_details', 'youtube', 'cities', 'is_featured'];
